...
<main class="content">
    <div class="d-flex justify-content-between ">
        ...
        <div class="d-flex align-items-center">
            ...
            <h5 class="mt-2">Landing Page galeri</h5>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 text-center">Pengaturan Halaman galeri</h5>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $result->fetch_assoc()) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-edit" data-bs-toggle="modal" data-bs-target="#editModal<?= $row['id_galeri'] ?>">
                                                        Edit
                                                    </button>
                                                    <a href="?q=proseshapusgaleri&id=<?= $row['id_galeri'] ?>" class="btn btn-danger btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <!-- Modal Edit -->
                                            <div class="modal fade" id="editModal<?= $row['id_galeri'] ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- Formulir Edit -->
                                                            <form action="?q=proseseditgaleri" method="post" enctype="multipart/form-data">
                                                                <!-- Input untuk ID -->
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="?q=prosestambahgaleri" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
