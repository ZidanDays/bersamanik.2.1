...
<main class="content">
    <div class="d-flex justify-content-between ">
        ...
        <div class="d-flex align-items-center">
            ...
            <h5 class="mt-2">Landing Page news</h5>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 text-center">Pengaturan Halaman news</h5>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $result->fetch_assoc()) : ?>
                                            <tr>
                                                ...
                                                <td style="text-align: justify;"> <?= $row['link'] ?> </td>
                                                <td style="text-align: justify;"> <?= $row['excerpt'] ?> </td>
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-edit mb-2" data-bs-toggle="modal" data-bs-target="#editModal<?= $row['id_news'] ?>">
                                                        Edit
                                                    </button>
                                                    <a href="?q=proseshapusnews&id=<?= $row['id_news'] ?>" class="btn btn-danger btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <!-- Modal Edit -->
                                            <div class="modal fade" id="editModal<?= $row['id_news'] ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- Formulir Edit -->
                                                            <form action="?q=proseseditnews" method="post" enctype="multipart/form-data">
                                                                <!-- Input untuk ID -->
                                                                <input type="hidden" name="id" value="<?= $row['id_news'] ?>">

                                                                <div class="mb-3">
                                                                    <label for="Judul" class="form-label">Link</label>
                                                                    <input type="text" class="form-control" id="Judul" name="Judul" placeholder="<?= $row['link'] ?>">
                                                                </div>
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="?q=prosestambahnews" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
