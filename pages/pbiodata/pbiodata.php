...
<main class="content">
    <div class="d-flex justify-content-between ">
        ...
        <div class="d-flex align-items-center">
            ...
            <h5 class="mt-2">Landing Page biodata</h5>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 text-center">Pengaturan Halaman biodata</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#editModal<?= $row['id_biodata'] ?>">
                                                Edit
                                            </button>
                                            <a href="?q=proseshapusbiodata&id=<?= $row['id_biodata'] ?>"
                                                class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <!-- Modal Edit -->
                                    <div class="modal fade" id="editModal<?= $row['id_biodata'] ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- Formulir Edit -->
                                                    <form action="?q=proseseditbiodata" method="post"
                                                        enctype="multipart/form-data">
                                                        <!-- Input untuk ID -->
                                                        <input type="hidden" name="id" value="<?= $row['id_biodata'] ?>">
