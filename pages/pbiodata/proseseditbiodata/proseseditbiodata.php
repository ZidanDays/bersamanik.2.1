...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["editGambar"]) && $_FILES["editGambar"]["error"] == 0) {
        ...
        $path_gambar = "uploads/konten_biodata/" . basename($editGambar["name"]);

        // Update data termasuk gambar baru
        $sql = "UPDATE biodata SET path_gambar = '$path_gambar', judul = '$judul', deksripsi = '$deskripsi' WHERE id_biodata = $id";
